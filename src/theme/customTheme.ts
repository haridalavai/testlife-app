...
export const theme:MantineThemeOverride = {
    ...
    //     indigo: ["#EBF4FF","#C3DAFE","#A3BFFA","#7F9CF5","#667EEA","#5A67D8","#4C51BF","#434190","#3C366B","#2A225D"],
    //     dark: ["#F7FAFC","#EDF2F7","#E2E8F0","#CBD5E0","#A0AEC0","#718096","#4A5568","#2D3748","#1A202C","#171923"],
    // },
    primaryColor: 'teal',
